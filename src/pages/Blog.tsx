            ...
            <div className=" w-full   ">
              <div className="relative md:w-[311px] mx-auto w-full ">
                <input
                  ...
                  name=""
                  id=""
                  className=" w-full h-[58px] border-[1px] border-gray-400  outline-none pl-2 rounded-xl "
                />
              ...
              <div className=" md:w-[215px] mx-auto  mt-10 ">
                ...
                <div className="flex   gap-x-3 items-center  font-normal text-base my-10">
                  ...
                  <div className=" w-[149px]">
                    ...
                    <p className=" text-sm text-text-links font-normal">
                      03 Aug 2022
                    </p>
                  </div>
                </div>
