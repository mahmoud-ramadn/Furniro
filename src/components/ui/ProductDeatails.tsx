      ...
      <div className="flex md:items-start flex-wrap md:flex-row flex-col gap-8">
        <div className="flex md:flex-col flex-row gap-8 justify-between  md:h-[416px]">
          {images.map((image: string, index: number) => (
            <div
              key={index}
              className={`md:w-20 w-1/4 md:h-20 h-fit rounded-lg overflow-hidden cursor-pointer ${
          ...
          <div className="md:w-20 w-1/4 nd:h-20 h-fit rounded-lg overflow-hidden cursor-pointer ">
            <AppImg
              className="w-full h-full rounded-lg"
      ...
      <div className="md:w-[606px] md:h-[730px]  rounded-md">
        ...
        <p className=" md:w-[450px]  text-sm font-normal">
         ...
         <div className=' mt-5  mb-[18px] h-16  flex flex-col justify-between'>
           <h4>Size</h4>
            ...
            <Btn className=' w-[30px] h-[30px] rounded text-white bg-secondary-500
             text-sm  font-normal
            '>L</Btn>
            <Btn className=' w-[30px] h-[30px] rounded   bg-primary-500
             text-sm  font-normal 
            '>XL</Btn>
            <Btn className=' w-[30px] h-[30px] rounded   bg-primary-500
             text-sm  font-normal
        ...
        <div className=" mt-8 mb-[60px] flex items-center gap-2  md:flex-nowrap flex-wrap">
         <Counter/>
          <Btn
           type='button'
            className="  md:w-[215px] border-[1px] w-full  rounded-2xl h-16 
             flex items-center justify-center text-xl font-normal">
            Add To Cart
          </Btn>
          <Btn
           type='button'
        ...
        <div className="  my-12 text-text-links text-base font-normal ">
          <div  className=' w-28 flex items-start justify-between '>
            ...
            <p  className=' flex items-center'><span className='px-3'>:</span> SS001 </p>
          </div>
          <div  className=' w-28 flex items-start justify-between '>
          ...
          <div  className=' w-28 flex items-start justify-between '>
            <span>SKU</span>
            <p><span className='px-3'>:</span> SS001 </p>
          </div>
